...
def apply(c: ConfigContainer):
    ...
    c.colors.completion.category.bg = c_bg_blue
    c.colors.completion.category.fg = c_fg
    c.colors.completion.category.border.bottom = c_bg_blue
    c.colors.completion.category.border.top = c_bg_blue
    ...
    c.colors.tabs.pinned.selected.even.bg = c_bg
    c.colors.tabs.pinned.selected.even.fg = c_fg
    c.colors.tabs.pinned.selected.odd.bg = c_bg
    c.colors.tabs.pinned.selected.odd.fg = c_fg
    c.colors.tabs.selected.even.bg = c_bg
    c.colors.tabs.selected.even.fg = c_fg
    c.colors.tabs.selected.odd.bg = c_bg
